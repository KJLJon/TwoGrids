...
o.post(i.saveColumns.url,n,function(o){i.onSave(o)})}
...
n=o.extend(!0,{url:"",top:"#tg",bottom:"#bg",topView:!1,bottomView:!1,topGrid:{},bottomGrid:{},saveColumns:"url",topRightClick:function(){},topDblClick:i,bottomRightClick:function(){},bottomDblClick:function(){}},n)
var r=function(i){if(0!=d)t!=i&&(t=i,d.setParam("id",i),d.reload())
else{t=i
var r={url:n.url,params:{model:"bottom",id:i}},l=o.extend(!0,{},s)
saveCols.model="bottom",0!=a&&(r.params.view=a,l.params.view=a),d=new e(n.bottom,{ajax:r,saveColumns:l,grid:n.bottomGrid,onRightClick:n.bottomRightClick,onDblClick:n.bottomDblClick})}},a=n.bottomView,l={url:n.url,params:{model:"top"}}
