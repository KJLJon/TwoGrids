...
var u=function(){o.post(i.saveColumns.url,o.extend({},i.saveColumns.params,{order:i.saveColumns.order,size:i.saveColumns.size,columns:JSON.stringify(l.getColumns())}),function(o){i.saveColumns.onSave(o)})}
...
l.model="bottom",0!=a&&(r.params.view=a,l.params.view=a),d=new e(n.bottom,{ajax:r,saveColumns:l,grid:n.bottomGrid,onRightClick:n.bottomRightClick,onDblClick:n.bottomDblClick})}},a=n.bottomView,l={url:n.url,params:{model:"top"}},s=0!=n.saveColumns
s={size:s,order:s,url:n.saveColumns,params:{model:"top"}}
var u=o.extend({},s)
0!=n.topView&&(l.params.view=n.topView,u.params.view=n.topView)
var c=new e(n.top,{ajax:l,saveColumns:u,grid:n.topGrid,onRightClick:n.topRightClick,onClick:i,onDblClick:n.topDblClick}),d=!1
