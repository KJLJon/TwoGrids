...
if(void 0===r[n]){var f=e-n+1
if(i.optimal>f){var m=Math.round((i.optimal-f)/2)
if(n-=m,e+=m,0>n&&(e-=n,n=0),void 0!==r[n])for(;void 0!==r[n];)n++,e++
...
var m={from:n,to:e,search:i.search,sort:i.sortColumn,asc:i.sortAsc}
a&&(m.loadColumns=!0),o.post(i.url,o.extend(m,i.params),function(o){var s=o.data.length
if(r.length!=parseInt(o.total)&&(t(),r.length=parseInt(o.total)),s!=f){i.optimal=s
...
var u=function(){var n=[o.extend({order:i.saveColumns.order,size:i.saveColumns.size},i.saveColumns.params)]
for(var t in l.getColumns())n.push({field:t.field,width:t.width})
o.post(i.saveColumns.url,n,function(o){onSave(o)})}
...
n=o.extend(!0,{url:"",top:"#tg",bottom:"#bg",topGrid:{},bottomGrid:{},saveColumns:"url",topRightClick:function(){},topDblClick:i,bottomRightClick:function(){},bottomDblClick:function(){}},n)
var r=function(i){if(0!=c)t!=i&&(t=i,c.setParam("id",i),c.reload())
else{t=i
var r=o.extend(!0,{},l)
r.params.id=i,r.params.model="bottom",0!=a&&(r.params.view=a),c=new e(n.bottom,{ajax:r,saveColumns:s,grid:n.bottomGrid,onRightClick:n.bottomRightClick,onDblClick:n.bottomDblClick})}},a=!1,l={url:n.url,params:{model:"top"}},s=0!=n.saveColumns
s={size:s,order:s,url:n.saveColumns}
var u=new e(n.top,{ajax:l,saveColumns:s,grid:n.topGrid,onRightClick:n.topRightClick,onClick:i,onDblClick:n.topDblClick}),c=!1
return{top:u,bottom:c,loadBottomGrid:r,setBottomView:function(o){0!=c&&c.setView(o),a=o},setTopView:function(o){u.setView(o)}}}var r=!1
